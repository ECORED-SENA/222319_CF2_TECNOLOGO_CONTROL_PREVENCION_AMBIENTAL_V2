...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
      ...
      .col-12
        .p-5
          ...
          .row.justify-content-center
            .col-lg-10.mb-3.mb-lg-5
              .row.justify-content-center.h-100
                .col-md-8.col-lg.bg-c13.p-4.m-lg-2.mb-4.mb-lg-0
                  figure.mb-5
                    img(src='@/assets/curso/tema3/img1.svg', style="width: 100px").m-auto
            ...
            .col-lg-8.bg-c16
              figure.mb-4
                img(src='@/assets/curso/tema3/img3.svg', style="width: 100px").m-auto
            ...
            .col-md-10.col-lg-6.bg-white.p-4.mb-4
              .row.align-items-center.mb-2
                .col-auto
                  figure
                    img(src='@/assets/curso/tema3/img6.svg', style="width: 20px").m-auto
                .col.ps-0
                  p.mb-0 Identificación de impactos.
              .row.align-items-center.mb-2
                .col-auto
                  figure
                    img(src='@/assets/curso/tema3/img7.svg', style="width: 20px").m-auto
                .col.ps-0
                  p.mb-0 Valoración de impactos.
              .row.align-items-center
                .col-auto
                  figure
                    img(src='@/assets/curso/tema3/img8.svg', style="width: 20px").m-auto
                .col.ps-0
            ...
            .col-lg-10.mt-4
              .row.justify-content-around.mb-0.mb-lg-5
                .col-8.col-md-6.col-lg.m-2.bg-c18.px-4.pb-4.mb-5.mb-lg-0
                  figure.fig-p2.mb-0
                    img(src='@/assets/curso/tema3/img9.svg', style="width: 80px").m-auto
                  p.txt-c3 01
                  p.text-center.mb-0 El tipo o naturaleza de la organización o proyecto que se esté evaluando.
                .col-8.col-md-6.col-lg.m-2.bg-c18.px-4.pb-4.mb-5.mb-lg-0
                  figure.fig-p2.mb-0
                    img(src='@/assets/curso/tema3/img10.svg', style="width: 80px").m-auto
                  p.txt-c3 02
    ...
    .row.align-items-center.mb-5
      ...
      .col-lg-6
        figure
          img(src='@/assets/curso/tema3/img5.png', style="width:550px").m-auto
    ...
    .tarjeta.tarjeta--azul.p-4.p-lg-5.mb-5
      SlyderA(tipo="b")
        ...
        .row.m-1
          ...
          .col-lg-7
            figure
              img(src='@/assets/curso/tema3/img12.png', style="width: 650px").m-auto
      ...
      .col-12.bg-c19.p-5
        ...
        .row
          .co-12.bg-c18.p-4.p-lg-5
            ...
            figure
              img(src='@/assets/curso/tema3/img17.svg', style="width: 650px").m-auto
