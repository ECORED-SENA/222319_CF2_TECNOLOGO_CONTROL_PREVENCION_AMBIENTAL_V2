...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    figure.mb-3
      img(src='@/assets/curso/tema4/img1.svg', style="width: 1150px").m-auto
    .row.mb-5
      .col-auto
        p.txt-c2 De acuerdo con la finalidad o el objetivo que se desea alcanzar, las medidas se pueden clasificar de la siguiente manera:
        ...
        .row.justify-content-center(titulo="Paso 1")
          .col-10.bg-c18.p-4
            ...
            .row.align-items-center
              .col-auto
                figure
                  img(src='@/assets/curso/tema4/img2.svg', style="width: 130px").m-auto
              .col
        ...
        .row.justify-content-center(titulo="Paso 2")
          .col-10.bg-c18.p-4
            ...
            .row.align-items-center
              .col-auto
                figure
                  img(src='@/assets/curso/tema4/img3.svg', style="width: 130px").m-auto
              .col
        ...
        .row.justify-content-center(titulo="Paso 3")
          .col-10.bg-c18.p-4
            ...
            .row.align-items-center
              .col-auto
                figure
                  img(src='@/assets/curso/tema4/img4.svg', style="width: 130px").m-auto
              .col
        ...
        .row.justify-content-center(titulo="Paso 4")
          .col-10.bg-c18.p-4
            ...
            .row.align-items-center
              .col-auto
                figure
                  img(src='@/assets/curso/tema4/img5.svg', style="width: 130px").m-auto
              .col
        ...
        .row.justify-content-center(titulo="Paso 5")
          .col-10.bg-c18.p-4
            ...
            .row.align-items-center
              .col-auto
                figure
                  img(src='@/assets/curso/tema4/img6.svg', style="width: 130px").m-auto
              .col
